  ...
  return (
    <nav className={`${NAV_BG} text-white px-4 py-2 flex items-center justify-between shadow-md relative`}>
      ...
      <div className="flex items-center gap-4">
        ...
        {/* Language select: only show on desktop */}
        <select className="ml-4 bg-[#102040] border border-blue-900 rounded px-2 py-1 text-white hidden md:inline-block">
      ...
      {mobileMenu && (
        <div className="fixed inset-0 bg-black bg-opacity-70 z-40 flex flex-col">
          ...
          <div className="flex flex-col items-center gap-6 mt-8 overflow-y-auto max-h-[80vh] px-4 w-full">
            {menu.map((dropdown) => (
            ...
            {/* Socials: show only in mobile menu */}
            ...
            {/* Language select: only in mobile menu */}
            <select className="bg-[#102040] border border-blue-900 rounded px-2 py-1 text-white md:hidden mt-4">
              <option value="nl">NL</option>
              <option value="en">EN</option>
            </select>
          </div>
